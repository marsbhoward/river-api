...
Stream.create(name: 'cbs', url: "https://reelgood.com/movies/source/cbs_all_access?filter-sort=1")#12
Stream.create(name: 'tbs', url: "https://reelgood.com/movies/source/tbs?filter-sort=1")#13
Stream.create(name: 'tnt', url: "https://reelgood.com/movies/source/tnt?filter-sort=1")#14
Stream.create(name: 'shudder', url: "https://reelgood.com/movies/source/shudder?filter-sort=1")#15
Stream.create(name: 'amc', url: "https://reelgood.com/movies/source/amc?filter-sort=1")#16
Stream.create(name: 'fx', url: "https://reelgood.com/movies/source/fx?filter-sort=1")#17
Stream.create(name: 'syfy', url: "https://reelgood.com/movies/source/syfy?filter-sort=1")#18
Stream.create(name: 'ifc', url: "https://reelgood.com/movies/source/ifc?filter-sort=1")#19
Stream.create(name: 'peacock', url: "https://reelgood.com/movies/source/peacock?filter-sort=1")#20
Stream.create(name: 'paramount', url: "https://reelgood.com/movies/source/paramount_plus?filter-sort=1")#21
